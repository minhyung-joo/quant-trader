...
public class Main {
    ...
    private static void financialAdvisorOperations(EClientSocket client) {
        ...
        //! [requestfaaliases]
        client.requestFA(Types.FADataType.ALIASES.ordinal());
        //! [requestfaaliases]

        //! [requestfagroups]
        client.requestFA(Types.FADataType.GROUPS.ordinal());
        //! [requestfagroups]

        //! [requestfaprofiles]
        client.requestFA(Types.FADataType.PROFILES.ordinal());
        //! [requestfaprofiles]

        /*** Replacing FA information - Fill in with the appropriate XML string. ***/
        //! [replacefaonegroup]
        client.replaceFA(Types.FADataType.GROUPS.ordinal(), FAMethodSamples.FaOneGroup);
        //! [replacefaonegroup]

        //! [replacefatwogroups]
        client.replaceFA(Types.FADataType.GROUPS.ordinal(), FAMethodSamples.FaTwoGroups);
        //! [replacefatwogroups]

        //! [replacefaoneprofile]
        client.replaceFA(Types.FADataType.PROFILES.ordinal(), FAMethodSamples.FaOneProfile);
        //! [replacefaoneprofile]

        //! [replacefatwoprofiles]
        client.replaceFA(Types.FADataType.PROFILES.ordinal(), FAMethodSamples.FaTwoProfiles);
        //! [replacefatwoprofiles]
